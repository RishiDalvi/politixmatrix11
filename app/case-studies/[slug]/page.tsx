        ...
        <article className="prose prose-lg max-w-none">
          <header className="mb-8">
            ...
            <div className="text-black mb-6">
              <p className="text-lg">By {caseStudy.writer}</p>
              <p className="text-sm">{caseStudy.date}</p>
            </div>
          </header>
